# handlers/rent.py (ПОЛНОСТЬЮ ГОТОВЫЙ КОД)

from telebot import types # Добавлен импорт types
...
def show_rent_menu(target, bot): # Принимает target (message ИЛИ call)
    ...
    if isinstance(target, types.CallbackQuery):
        # Если пришел колбэк (например, нажатие "Назад"), РЕДАКТИРУЕМ сообщение
        ...
        # Если пришло сообщение (первое нажатие с Reply Keyboard), ОТПРАВЛЯЕМ новое сообщение
        bot.send_message(
...
def register_handlers(bot):
    ...
    # show_rent_menu теперь умеет обрабатывать и колбэк, и сообщение!
